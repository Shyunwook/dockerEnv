      ...
      var o = r(8),
        ...
        c = (function (e) {
          function t() {
            ...
            return (
              (t.content = 0), (t.fg = 0), (t.bg = 0), (t.extended = new a.ExtendedAttrs()), (t.combinedData = ""), t
            );
          }
          return (
            n(t, e),
            ...
            (t.prototype.setFromCharData = function (e) {
              ...
              if (e[s.CHAR_DATA_CHAR_INDEX].length > 2) t = !0;
                ...
                if (55296 <= r && r <= 56319) {
                  ...
                  56320 <= i && i <= 57343
                    ? (this.content = (1024 * (r - 55296) + i - 56320 + 65536) | (e[s.CHAR_DATA_WIDTH_INDEX] << 22))
                    : (t = !0);
                } else t = !0;
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.utf32ToString = function (e, t, r) {
          ...
          for (var i = "", n = t; n < r; ++n) {
            var o = e[n];
            o > 65535
              ? ((o -= 65536), (i += String.fromCharCode(55296 + (o >> 10)) + String.fromCharCode((o % 1024) + 56320)))
        ...
        return (
          ...
          (e.prototype.decode = function (e, t) {
            ...
            if (this.interim[0]) {
              ...
              for (
                var d = 192 == (224 & this.interim[0]) ? 2 : 224 == (240 & this.interim[0]) ? 3 : 4, p = d - f;
                l < p;
            ...
            for (var v = r - 4, g = l; g < r; ) {
              for (
                ;
                !(!(g < v) || 128 & (i = e[g]) || 128 & (n = e[g + 1]) || 128 & (o = e[g + 2]) || 128 & (s = e[g + 3]));
    ...
    function (e, t, r) {
      ...
      var a = (function () {
        function e(e, t, r) {
          ...
          for (
            var i = t || o.CellData.fromCharData([0, n.NULL_CELL_CHAR, n.NULL_CELL_WIDTH, n.NULL_CELL_CODE]), s = 0;
            s < e;
            ++s
          )
            this.setCell(s, i);
          ...
          return (
            ...
            (t.prototype.print = function (e, t, r) {
              ...
              this._dirtyRowService.markDirty(o.y),
                o.x &&
                  r - t > 0 &&
                  2 === _.getWidth(o.x - 1) &&
                  _.setCellFromCodePoint(o.x - 1, 0, 1, f.fg, f.bg, f.extended);
              for (var p = t; p < r; ++p) {
                ...
                if ((a && this._onA11yChar.fire(u.stringFromCodePoint(i)), n || !o.x)) {
                  ...
                  if (
                    (h &&
                      ...
                      2 === _.getWidth(c - 1) &&
                        _.setCellFromCodePoint(c - 1, d.NULL_CELL_CODE, d.NULL_CELL_WIDTH, f.fg, f.bg, f.extended)),
            ...
            (t.prototype.deleteLines = function (e) {
              ...
              if (!(r.y > r.scrollBottom || r.y < r.scrollTop)) {
                var i,
                  n = r.ybase + r.y;
                for (
                  i = this._bufferService.rows - 1 - r.scrollBottom, i = this._bufferService.rows - 1 + r.ybase - i;
                  t--;
            ...
            (t.prototype.charAttributes = function (e) {
              if (1 === e.length && 0 === e.params[0])
                return (
                  (this._curAttrData.fg = f.DEFAULT_ATTR_DATA.fg), void (this._curAttrData.bg = f.DEFAULT_ATTR_DATA.bg)
                );
            ...
            (t.prototype.selectCharset = function (e) {
              2 === e.length
                ? "/" !== e[0] && this._charsetService.setgCharset(b[e[0]], a.CHARSETS[e[1]] || a.DEFAULT_CHARSET)
        ...
        O = (function (e) {
          ...
          return (
                ...
                case "screenReaderMode":
                  this.optionsService.options.screenReaderMode
                    ? !this._accessibilityManager &&
                      this._renderService &&
                      (this._accessibilityManager = new y.AccessibilityManager(this, this._renderService))
              ...
              this.register(
                this._coreMouseService.onProtocolChange(function (t) {
                  t
                    ...
                    16 & t
                      ? n.wheel || (r.addEventListener("wheel", s, { passive: !1 }), (n.wheel = s))
            ...
            (t.prototype._keyDown = function (e) {
              if (((this._keyDownHandled = !1), this._customKeyEventHandler && !1 === this._customKeyEventHandler(e)))
                return !1;
      ...
      var o = r(5),
        ...
        a = (function () {
          ...
          return (
            ...
            (e = i(
              [n(2, s.IBufferService), n(3, s.IOptionsService), n(4, o.ICharSizeService), n(5, s.ICoreService)],
              e
            ))
          );
        })();
        ...
        u = (function (e) {
          ...
          return (
            ...
            (t.prototype.syncScrollArea = function (e) {
              if (
                (void 0 === e && (e = !1), this._lastRecordedBufferLength !== this._bufferService.buffer.lines.length)
              )
                return (
            ...
            (t.prototype._bubbleScroll = function (e, t) {
              ...
              return (
                !((t < 0 && 0 !== this._viewportElement.scrollTop) || (t > 0 && r < this._lastRecordedBufferHeight)) ||
          ...
          (r.prototype.parse = function (e, t) {
            for (
              ...
              switch ((i = l[(n << 8) | ((r = e[h]) < 160 ? r : 160)]) >> 4) {
                ...
                case 1:
                  if (
                    this._errorHandler({ position: h, code: r, currentState: n, collect: a, params: c, abort: !1 })
                      .abort
                  )
                    return;
                  break;
            ...
            (t.prototype._render = function (e) {
              if (this._coreService.isCursorInitialized && !this._coreService.isCursorHidden) {
                ...
                if (r < 0 || r >= this._bufferService.rows) this._clearCursor();
                  ...
                  if (
                    (this._bufferService.buffer.lines.get(t).loadCell(i, this._cell), void 0 !== this._cell.content)
                  ) {
                      ...
                      function (e) {
                        o._onLinkTooltip.fire(o._createLinkHoverEvent(a, l, h, u, n)),
                          i.hoverTooltipCallback &&
                            i.hoverTooltipCallback(e, r, { start: { x: a, y: l }, end: { x: h, y: u } });
                      },
                      function () {
              ...
              if ((void 0 === r && (r = !0), void 0 === i && (i = !0), !(e[0] >= this._bufferService.cols))) {
                ...
                if (o) {
                  ...
                  if (" " === s.charAt(a)) {
                    ...
                    for (
                      ;
                      p < o.length && c + 1 < s.length && !this._isCharWordSeparator(o.loadCell(p + 1, this._workCell));
                ...
                switch (y) {
                  ...
                  case 33554432:
                    this._workCell.isBold() &&
                      ...
                      (g += 8),
                      this._applyMinimumContrast(v, this._colors.background, this._colors.ansi[g]) ||
                  ...
                  default:
                    this._applyMinimumContrast(v, this._colors.background, this._colors.foreground) ||
                      (m && v.classList.add("xterm-fg-" + i.INVERTED_DEFAULT_COLOR));
                }
                switch (S) {
                  case 16777216:
                  case 33554432:
            ...
            (t.prototype.refreshRows = function (e, t, r) {
              void 0 === r && (r = !1),
                this._isPaused
                  ...
                  : (r || (this._isNextRenderRedrawOnly = !1), this._renderDebouncer.refresh(e, t, this._rowCount));
            }),
            (t.prototype._renderRows = function (e, t) {
        ...
        S = (function (e) {
          ...
          return (
            ...
            (t.prototype.scroll = function (e, t) {
              ...
              ((r = this._cachedBlankLine) && r.length === this.cols && r.getFg(0) === e.fg && r.getBg(0) === e.bg) ||
              ...
              switch (e) {
                ...
                case "windowsMode":
                  this.optionsService.options.windowsMode
                    ...
                    : (null === (t = this._windowsMode) || void 0 === t || t.dispose(), (this._windowsMode = void 0));
              }
            }),
          ...
          (e.prototype.getNullCell = function (e) {
            return (
              e
                ...
                : ((this._nullCell.fg = 0), (this._nullCell.bg = 0), (this._nullCell.extended = new h.ExtendedAttrs())),
              this._nullCell
            );
          }),
            ...
            for (var r = this.getNullCell(n.DEFAULT_ATTR_DATA), i = [], o = 0, s = this.lines.length - 1; s >= 0; s--) {
              ...
              if (!(!c || (!c.isWrapped && c.getTrimmedLength() <= e))) {
                ...
                if (!(h >= s && h < s + l.length)) {
                  ...
                  p.length > 0 && (i.push({ start: s + l.length + o, newLines: p }), (o += p.length)),
                    l.push.apply(l, p);
                  var y = f.length - 1,
                    b = f[y];
                  0 === b && (b = f[--y]);
                  for (var S = l.length - _ - 1, m = u; S >= 0; ) {
                    var C = Math.min(m, b);
                    if (
                      (l[y].copyCellsFrom(l[S], m - C, b - C, C, !0), 0 === (b -= C) && (b = f[--y]), 0 === (m -= C))
                    ) {
                      S--;
                      var w = Math.max(S, 0);
          ...
          (e.prototype.stringIndexToBufferIndex = function (e, t, r) {
            for (void 0 === r && (r = !1); t; ) {
              ...
              for (var n = r ? i.getTrimmedLength() : i.length, o = 0; o < n; ++o)
                if ((i.get(o)[s.CHAR_DATA_WIDTH_INDEX] && (t -= i.get(o)[s.CHAR_DATA_CHAR_INDEX].length || 1), t < 0))
                  return [e, o];
              e++;
            }
            return [e, 0];
                ...
                for (var u = 0, f = i(h, u, t), _ = 1, d = 0; _ < h.length; ) {
                  ...
                  h[u].copyCellsFrom(h[_], d, f, y, !1),
                    ...
                    0 === f &&
                      ...
                      (h[u].copyCellsFrom(h[u - 1], r - 1, f++, 1, !1), h[u - 1].setCell(r - 1, o));
                }
        ...
        u = (function () {
          ...
          return (
            ...
            (e.prototype.triggerMouseEvent = function (e) {
              ...
              if ((e.col++, e.row++, 32 === e.action && this._lastEvent && this._compareEvents(this._lastEvent, e)))
                return !1;
    ...
    function (e, t, r) {
      ...
      t.updateWindowsModeWrappedState = function (e) {
        ...
        n &&
          r &&
          (n.isWrapped =
            r[i.CHAR_DATA_CODE_INDEX] !== i.NULL_CELL_CODE && r[i.CHAR_DATA_CODE_INDEX] !== i.WHITESPACE_CELL_CODE);
      };
    },
    function (e, t, r) {
      "use strict";
        ...
        return (
          ...
          (e.prototype._innerWrite = function () {
            for (var e = this, t = Date.now(); this._writeBuffer.length > this._bufferOffset; ) {
              ...
              if (
                (this._bufferOffset++, this._action(r), (this._pendingData -= r.length), i && i(), Date.now() - t >= 12)
              )
                break;
            }
