...
// ["css/xterm.css", "lib/xterm.js"].forEach(function (f) {
//   console.log(path.join(basePath, f));
//   staticFiles["/" + f] = fs.readFileSync(path.join(basePath, f));
// });
var temp = path.join(require.resolve("xterm-addon-fit"));
staticFiles["/addons/fit/fit.js"] = fs.readFileSync(path.join(temp));
staticFiles["/xterm.css"] = fs.readFileSync("xterm.css");
staticFiles["/xterm.js"] = fs.readFileSync("xterm.js");
